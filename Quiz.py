...
class QuizApp:
    def __init__(self, root):
        ...
        self.questions = [
            {"question": "which planet has the most moons?", "options": ["saturn", "venus", "earth", "mars"], "answer": "saturn"},
            {"question": "Which planet is known as the Red Planet?", "options": ["Mars", "Venus", "Earth", "Jupiter"], "answer": "Mars"},
            {"question": "what netflix show had the most streaming view in 2021?", "options": ["squid game", "money heist", "Got", "The Witcher"], "answer": "squid game"}
        ]
